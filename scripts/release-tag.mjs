...
//   - Verifies a CHANGELOG section exists for the version about to ship
...
main(async () => {
  ...
  if (changelog) {
    ...
    if (m) {
      ...
      log.warn(
        `No CHANGELOG section found for v${pkg.version}. The GitHub Release body will fall back to a generic link.`,
      );
    }
  }
